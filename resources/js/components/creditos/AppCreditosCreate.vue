    ...
    export default {
        ...
        computed:{
            ...
            GastosEscrituracion:function () {
                 ...
                 * + GastoProtocolo
                 */
                let monto = this.MontoFincaExtra + this.MontoHonorariosNotario + this.MontoIVA + this.TimbreNotarial
                    + this.CuotaArancel + this.PrimaArancel + this.ConsultaElectronica + this.ReferenciaRGP
                    + this.Imprevistos + this.RazonRegistral + this.GastosPapeleria + this.GastosProtocolo;
            ...
            TotalGastos:function () {
                 ...
                 */
                let monto = parseFloat(this.seguro_sp) + parseFloat(this.interes_sp) + parseFloat(this.seguro_vida)
                    + parseFloat(this.avaluo) + parseFloat(this.saldo_aportacion) + parseFloat(this.saldo_ahorro)
