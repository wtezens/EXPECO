        ...
        *{
        ...
        @media (max-width: 639px){
            body{
                min-height: 100vh;
                background: #862223;
                background: -moz-linear-gradient(left, #B71C1C 0%, #C62828 50%, #B71C1C 100%);
                background: -webkit-linear-gradient(left, #B71C1C 0%, #C62828 50%, #B71C1C 100%);
...
<div class="content">
    ...
    <div class="text">
        <strong style="color:#000">Error 403.</strong> Acceso Denegado. <br />
        El acceso a este recurso esta restringido. Aseg&uacute;rese que tenga los permisos necesarios.
        <br>
