    ...
    public function query()
    {
        return Credit::query()
            ...
            ->select(
                ...
                'credits.cuenta',
                'credits.credito_id',
                DB::raw("DATE_FORMAT(credits.created_at,        '%d-%m-%Y') as fecha_creado"),
                DB::raw("DATE_FORMAT(liquidations.created_at,   '%d-%m-%Y') as liquidacion_creada"),
                'liquidations.fecha_pago',
                DB::raw("DATE_FORMAT(advances.updated_at,       '%d-%m-%Y') as fecha_anticipo"),
                DB::raw("DATE_FORMAT(credits.updated_at,        '%d-%m-%Y') as fecha_actualizado"),
